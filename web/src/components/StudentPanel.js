  ...
  return (
    <div style={{ background: 'transparent', minHeight: '100%', padding: '8px 0 24px', fontFamily: '-apple-system, BlinkMacSystemFont, sans-serif' }}>
        ...
        <div style={{ position: 'fixed', inset: 0, background: 'rgba(15, 23, 42, 0.36)', backdropFilter: 'blur(8px)', display: 'flex', alignItems: 'center', justifyContent: 'center', zIndex: 1000, padding: '24px' }}>
          <div style={{ background: appTheme.card, borderRadius: '24px', width: '100%', maxWidth: '620px', display: 'flex', flexDirection: 'column', boxShadow: '0 24px 48px rgba(15, 23, 42, 0.14)', border: `1px solid ${appTheme.border}`, overflow: 'hidden' }} className="kin-scrollbar">
            <div style={{ padding: '24px', borderBottom: `1px solid ${appTheme.border}`, display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', gap: '16px' }}>
              ...
              <button onClick={() => setShowBorrowModal(false)} style={{ border: `1px solid ${appTheme.border}`, background: '#fff', width: '40px', height: '40px', borderRadius: '12px', cursor: 'pointer', color: appTheme.textMuted, display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}>
                <X size={18} />
              </button>
            </div>
            ...
            <form onSubmit={handlePostRequest} style={{ width: '100%', textAlign: 'left', padding: '24px', boxSizing: 'border-box' }}>
              ...
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', gap: '14px', marginTop: '22px' }}>
                ...
                <button type="submit" style={{ background: appTheme.button, color: '#fff', border: 'none', padding: '13px 18px', borderRadius: '14px', fontWeight: '700', cursor: 'pointer', display: 'inline-flex', alignItems: 'center', gap: '8px' }}>
      ...
      <div style={{ maxWidth: '980px', margin: '0 auto' }}>
        <div style={{ ...sectionCardStyle, marginBottom: '20px', display: 'flex', justifyContent: 'space-between', gap: '20px', alignItems: 'flex-start', flexWrap: 'wrap' }}>
          <div>
          ...
          <div style={{ display: 'flex', gap: '10px', flexWrap: 'wrap' }}>
            <div style={{ padding: '12px 14px', borderRadius: '14px', background: '#f8fafc', border: `1px solid ${appTheme.border}`, display: 'flex', alignItems: 'center', gap: '10px' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '20px' }}>
          <div style={actionCardStyle} onClick={() => setShowBorrowModal(true)}>
            <div>
          ...
          <div style={actionCardStyle} onClick={() => navigate('/borrow')}>
            <div>
              <Heart size={34} color={appTheme.primary} />
