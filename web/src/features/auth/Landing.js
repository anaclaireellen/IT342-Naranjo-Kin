  ...
  return (
    <div style={{ minHeight: '100vh', background: appTheme.background, padding: '28px', fontFamily: '-apple-system, BlinkMacSystemFont, sans-serif' }}>
      <div style={{ maxWidth: '1120px', margin: '0 auto' }}>
        ...
        <div className="kin-animate-in" style={{ background: '#ffffff', border: `1px solid ${appTheme.border}`, borderRadius: '28px', boxShadow: appTheme.shadow, overflow: 'hidden' }}>
          <div style={{ display: 'grid', gridTemplateColumns: '1.25fr 0.85fr', gap: '0', minHeight: 'min(720px, calc(100vh - 160px))' }}>
            <section style={{ padding: '56px 48px', display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
              <div>
                <div style={{ display: 'inline-flex', padding: '8px 13px', borderRadius: '999px', background: appTheme.cardAlt, color: appTheme.primary, fontSize: '12px', fontWeight: '700', letterSpacing: '0.08em', textTransform: 'uppercase', marginBottom: '22px', boxShadow: '0 10px 22px rgba(26,76,124,0.1)' }}>
                ...
                <div style={{ display: 'flex', gap: '12px', flexWrap: 'wrap', marginTop: '28px' }}>
                  <button className="kin-interactive-button" onClick={() => navigate('/login')} style={primaryButton}>
                    Log In <ArrowRight size={18} />
                  </button>
                  <button className="kin-interactive-button" onClick={() => navigate('/register')} style={secondaryButton}>
                    Create Account
                  </button>
                </div>
              </div>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(220px, 1fr))', gap: '14px', marginTop: '32px' }}>
                <div className="kin-interactive-card" style={{ ...featureCard, background: 'linear-gradient(180deg, #ffffff 0%, rgba(22,121,133,0.08) 100%)' }}>
                ...
                <div className="kin-interactive-card" style={{ ...featureCard, background: 'linear-gradient(180deg, #ffffff 0%, rgba(89,208,198,0.12) 100%)' }}>
                  <ShieldCheck size={18} color={appTheme.accent} />
